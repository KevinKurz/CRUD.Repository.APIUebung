...
namespace CRUD.xUnitTests.Repository_ReservationRepository
{
    public class ReservationRepositoryExpectedBehavior
    {
        ...
        {
            //Arrange
            CreateReservationQuery testDto = new CreateReservationQuery(1, "test", "2:00", "4:00", "1.1.1001");
            //Act
        ...
        public void Core_Repository_ReservationRepository_UpdateByID_Successfull()
        {
            ...
            UpdateReservationQuery updateDto = new UpdateReservationQuery(1, "test", "1:00", "4:00", "3.1.1001");

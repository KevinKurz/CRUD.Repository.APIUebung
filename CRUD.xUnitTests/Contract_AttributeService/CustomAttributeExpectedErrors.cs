...
namespace CRUD.xUnitTests.Contract_AttributeService
{
    public class CustomAttributeExpectedErrors
    {
        ...
        public void DataStructures_AttributeService_DateValidationAttribute_IsAttributeValid()
        {
            ...
            //Arrange
            CreateReservationQuery dto = new CreateReservationQuery(1, "TestName", "00:00", "01:00", testDate);
            //Act
        ...
        public void DataStructures_AttributeService_EndtimeEarlierThanStarttimeAttribute_IsStarttimeInTimeonly()
        {
            ...
            //Arrange
            CreateReservationQuery dto = new CreateReservationQuery(1, "TestName", testTime, "1:00", "1.1.1001");
            //Act
        ...
        public void DataStructures_AttributeService_EndtimeEarlierThanStarttimeAttribute_IsEndtimeInTimeonly()
        {
            string testTime = "no_TimeOnly";
            //Arrange
            CreateReservationQuery dto = new CreateReservationQuery(1, "TestName", "1:00", testTime, "1.1.1001");
            //Act
        ...
        public void DataStructures_AttributeService_EndtimeEarlierThanStarttimeAttribute_IsTimecomparisonValid()
        {
            ...
            string endTime = "1:00";
            //Arrange
            CreateReservationQuery dto = new CreateReservationQuery(1, "TestName", startTime, endTime, "1.1.1001");
            //Act
        ...
        public void DataStructures_AttributeService_Validator_IsIsValidMethodWorking()
        {
            int kapacity = 12;
            //Arrange
            CreateReservationQuery dto = new CreateReservationQuery(kapacity, "TestName", "1:00", "2:00", "1.1.1001");
            //Act

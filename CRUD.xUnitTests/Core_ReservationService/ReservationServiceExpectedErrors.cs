...
namespace CRUD.xUnitTests.Core_ReservationService
{
    public class ReservationServiceExpectedErrors
    {
        ...
        [Fact]
        public void CORE_ReservationService_ReservationRepository_Create_NotimplementedException_ForEndtime()
        {
            //Arrange
        ...
        [Fact]
        public void CORE_ReservationService_ReservationRepository_Create_NotimplementedException_ModelSurroundsReservation()
        {
            //Arrange
            CreateReservationDto dto = new CreateReservationDto(1, "test", "2:00", "6:00", "1.1.1001");
        ...
        [Fact]
        public void CORE_ReservationService_ReservationRepository_Update_NotimplementedException_ForStarttime()
        {
            //Arrange
            ReservationModel listFiller = new ReservationModel(1, "test", "2:00", "4:00", "1.1.1001");
        ...
        [Fact]
        public void CORE_ReservationService_ReservationRepository_Update_NotimplementedException_ForEndtime()
        {
            //Arrange
            ReservationModel listFiller = new ReservationModel(1, "test", "2:00", "4:00", "1.1.1001");
            ReservationModel createDto = new ReservationModel(1, "test", "2:00", "5:00", "2.1.1001");

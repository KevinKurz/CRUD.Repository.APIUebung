...
namespace CRUD.xUnitTests.Repository_TableRepository
{
    public class TableRepositoryExpectedBehavior
    {
        ...
        {
            //Arrange
            CreateTableQuery testDto = new CreateTableQuery(1, "GoodTable");
            //Act
        ...
        {
            //Arrange
            CreateTableQuery createDto = new CreateTableQuery(1, "BadTable");
            UpdateTableQuery updateDto = new UpdateTableQuery(1, "GoodTable");

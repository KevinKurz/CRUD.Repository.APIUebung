...
{
    public class ReservationRepository2 : IRepository<IReservationDto, IQueryParams>
    {
        private IDataService<IModel> _jsonService;
        public ReservationRepository2(IDataService<IModel> jsonService) // Create a constructor, in which you define which JsonService you want to include
        {
        ...
        public IEnumerable<IReservationDto> GetAll(int tableID, IQueryParams query)
        {
        ...
        public IReservationDto GetById(int tableId, int reservationId, IQueryParams query)
        {
